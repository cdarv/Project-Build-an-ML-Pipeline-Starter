...
def go(args):
    ...
    # Fixing the testing failure - point outside of the boundaries
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        # This was originally "ininital", i've corrected it in this file and the MLproject file as a typo
